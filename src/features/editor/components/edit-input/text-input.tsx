...
const textInputFormSchema = z.object({
  label: z.string().min(1),
  placeholder: z.string().min(1),
  description: z.string().optional(),
  disabled: z.boolean(),
  value: z.string().optional(),
  validationType: z.enum(InputValidationType),
  required: z.boolean(),
...
const TextInput = ({ defaultValues, onSubmit, onDelete, disabled }: EditInputProps) => {
  const form = useForm<z.infer<typeof textInputFormSchema>>({
    ...
    defaultValues: {
      ...
      validationType: defaultValues.validationType,
            ...
            <FormItem>
              ...
              <FormControl>
                <Select onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    {Object.values(InputValidationType).map((type) => (
