...
export const NumberFormatOpreation = {
    ...
    label: "Number Format",
    icon: (props: LucideProps) => <DecimalsArrowRight className={cn("stroke-muted-foreground", props.className)} {...props} />,
    ...
    inputs: [
        ...
        },
        {
            ...
            required: false,
            hideHandle: true,
            options: [{ value: "0", label: "0" }, { value: "1", label: "1" }, { value: "2", label: "2" }, { value: "3", label: "3" }, { value: "4", label: "4" }, { value: "5", label: "5" }, { value: "6", label: "6" }]
        },
        {
            name: "Number Format",
            type: NodeStaticInputType.SELECT,
